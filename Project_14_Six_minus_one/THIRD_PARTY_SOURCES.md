...
| GazeCloud reference/example files | https://gazerecorder.com/ | Third-party reference material, not bundled in the final codebase ZIP | Treat as third-party reference/example material, not team-authored code | Integration reference for GazeCloudAPI | Used during integration research; runtime uses `eye/index.html`, `eye/app.js`, and the provider CDN script |
